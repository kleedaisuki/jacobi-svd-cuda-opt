...
# Fused cooperative-kernel Nsight sweep using representative baseline cases.
# 使用代表性 baseline 用例的融合 cooperative kernel Nsight 扫描。
...
case_ncu_basic_args --kernel-name regex:jacobi_sweep_kernel --launch-count 2
